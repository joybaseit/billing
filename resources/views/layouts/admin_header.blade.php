    ...
    <div class="wrapper">
        <nav id="sidebar" class="active">
            <div class="sidebar-header">
                <img src="{{ asset('img/bootstraper-logo.png') }}" alt="bootraper logo" class="app-logo">
            </div>
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    <a href="#uielementsmenu" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle no-caret-down"><i class="fas fa-layer-group"></i> Billing</a>
                    <ul class="collapse list-unstyled" id="uielementsmenu">
                        <li>
                            <a href="/newbill"><i class="fas fa-angle-right"></i> New Billing</a>
                        </li>
                        <li>
                            <a href="/list"><i class="fas fa-angle-right"></i> Billing List</a>
                        </li>
                    </ul>
                </li>
               
                <li>
                    <a href="/add"><i class="fas fa-cog"></i>Settings</a>
                </li>
            </ul>
        </nav>
